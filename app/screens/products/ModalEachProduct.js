...
const ModalEachProduct=(props) =>{
  ...
  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
      ...
      <Text style={{flex:0.06,fontSize: 17,fontWeight: 'bold',}}>{productStore.selectedProducts.name}</Text>
      <Text style={{flex:0.06,fontSize: 16}}>{productStore.selectedProducts.description}</Text>
      ...
      <Text style={{fontSize: 17,fontWeight: 'bold',color:'#6200EE'}}>{productStore.selectedProducts.price}</Text>
      </View>
      <NumericInput
